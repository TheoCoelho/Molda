...
const Profile = () => {
  ...
  // Dados mock das se├º├Áes (restaurados)
  const [creations] = useState([
    ...
    { id: 3, title: "Jaqueta Retr├┤",   date: "28/12/2023", status: "producao" as const,   thumbnail: "/api/placeholder/200/120" },
  ]);

  const [savedElements] = useState([
    { id: 1, type: "image", name: "Logo Empresa", preview: "/api/placeholder/100/100" },
    { id: 2, type: "text",  name: "Frase Motivacional", content: "Seja a mudan├ºa" },
    { id: 3, type: "drawing", name: "Desenho Abstrato", preview: "/api/placeholder/100/100" },
    { id: 4, type: "pattern", name: "Padr├úo Geom├®trico", preview: "/api/placeholder/100/100" },
  ]);
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="flex items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-500">Cria├º├Áes</div>
                </div>
              </div>
            </div>
          </CardHeader>
        ...
        <Tabs defaultValue="creations" className="w-full">
          <TabsList className="grid w-full grid-cols-2 max-w-md mx-auto">
            <TabsTrigger value="creations">Minhas Pe├ºas</TabsTrigger>
              ...
              {savedElements.map((el: any) => (
                <Card key={el.id} className="shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <CardContent>
                    ...
                    <div className="flex gap-2">
                      <Button variant="outline" className="w-full">Editar</Button>
                      <Button className="w-full">Adicionar ├á pe├ºa</Button>
                    </div>
                  </CardContent>
                </Card>
              ))}
